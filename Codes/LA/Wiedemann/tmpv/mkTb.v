...
module mkTb(CLK,
  ...
  wire [2 : 0] ifc$polynomial__write_1, ifc$start_s_in;
  wire ifc$EN_poly_length__write, ifc$EN_polynomial__write, ifc$EN_start;

  // ports of submodule ifc2
  wire [2 : 0] ifc2$wiedemann_out__read, ifc2$wiedemann_out__write_1;
  ...
  assign WILL_FIRE_RL_theUltimateAnswer =
	     ifc2$RDY_wiedemann_out__read && i == 32'd1 ;
  ...
  assign ifc$polynomial__write_1 = 3'h0 ;
  assign ifc$start_s_in = 3'h0 ;
  assign ifc$EN_start = 1'b0 ;
  assign ifc$EN_polynomial__write = 1'b0 ;
  assign ifc$EN_poly_length__write = 1'b0 ;

  // submodule ifc2
  assign ifc2$wiedemann_out__write_1 = 3'h0 ;
