...
module mkEllBMVM(CLK,
  ...
  wire [31 : 0] x__h2568, y__h9344;
  wire [4 : 0] x__h9323;
  wire [3 : 0] IF_x309_OR_lut_serverAdapter_outData_outDataw_ETC__q1;
  ...
  // register out
  assign out$D_IN = (x__h2627 ^ y__h2628) ? out | x__h2568 : out & y__h9344 ;
  ...
  // remaining internal signals
  assign IF_x309_OR_lut_serverAdapter_outData_outDataw_ETC__q1 =
	     (x__h6309 | lut_serverAdapter_outData_outData$wget[4]) ?
	       4'd1 :
	       4'd0 ;
  ...
  assign x__h2568 = 32'd1 << x__h9323 ;
  assign x__h2627 = x__h2642 ^ y__h2643 ;
  assign x__h2642 = x__h2657 ^ y__h2658 ;
  assign x__h2657 = x__h2672 ^ y__h2673 ;
  assign x__h2672 =
	     lut_serverAdapter_outData_outData$wget[25] &
	     in[lut_serverAdapter_outData_outData$wget[24:20]] ;
  assign x__h2744 = in[lut_serverAdapter_outData_outData$wget[4:0]] ;
  assign x__h4385 = in[lut_serverAdapter_outData_outData$wget[9:5]] ;
  assign x__h6026 = in[lut_serverAdapter_outData_outData$wget[14:10]] ;
  assign x__h6309 = x__h6311 | lut_serverAdapter_outData_outData$wget[3] ;
  assign x__h6311 = x__h6313 | lut_serverAdapter_outData_outData$wget[2] ;
  assign x__h6313 =
	     lut_serverAdapter_outData_outData$wget[0] |
	     lut_serverAdapter_outData_outData$wget[1] ;
  assign x__h6649 = x__h6651 | lut_serverAdapter_outData_outData$wget[8] ;
  assign x__h6651 = x__h6653 | lut_serverAdapter_outData_outData$wget[7] ;
  assign x__h6653 =
	     lut_serverAdapter_outData_outData$wget[5] |
	     lut_serverAdapter_outData_outData$wget[6] ;
  assign x__h6993 = x__h6995 | lut_serverAdapter_outData_outData$wget[13] ;
  assign x__h6995 = x__h6997 | lut_serverAdapter_outData_outData$wget[12] ;
  assign x__h6997 =
	     lut_serverAdapter_outData_outData$wget[10] |
	     lut_serverAdapter_outData_outData$wget[11] ;
  assign x__h7667 = in[lut_serverAdapter_outData_outData$wget[19:15]] ;
  assign x__h8978 = x__h8980 | lut_serverAdapter_outData_outData$wget[18] ;
  assign x__h8980 = x__h8982 | lut_serverAdapter_outData_outData$wget[17] ;
  assign x__h8982 =
	     lut_serverAdapter_outData_outData$wget[15] |
	     lut_serverAdapter_outData_outData$wget[16] ;
  assign x__h9323 = row_num - 5'd1 ;
  assign y__h2628 = x__h7667 & y__h7668 ;
  assign y__h2643 = x__h6026 & y__h6027 ;
  assign y__h2658 = x__h4385 & y__h4386 ;
  assign y__h2673 =
	     x__h2744 &
	     IF_x309_OR_lut_serverAdapter_outData_outDataw_ETC__q1[0] ;
  assign y__h4386 = x__h6649 | lut_serverAdapter_outData_outData$wget[9] ;
  assign y__h6027 = x__h6993 | lut_serverAdapter_outData_outData$wget[14] ;
  assign y__h7668 = x__h8978 | lut_serverAdapter_outData_outData$wget[19] ;
  assign y__h9344 = ~x__h2568 ;
